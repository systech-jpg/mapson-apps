        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold">Jenis Cuti</h1>
                    <Can on="leave-types" do="create"><Button onClick={openCreate}><Plus className="size-4" /> Tambah</Button></Can>
                </div>
                                    ...
                                    <TableRow key={t.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                <Can on="leave-types" do="edit"><Button variant="ghost" size="icon" onClick={() => openEdit(t)}><Pencil className="size-4" /></Button></Can>
                                                <Can on="leave-types" do="delete"><ConfirmDelete url={route('leave-types.destroy', t.id)} title={`Hapus ${t.name}?`} description="Jika sudah dipakai, akan dinonaktifkan." /></Can>
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                ))}
